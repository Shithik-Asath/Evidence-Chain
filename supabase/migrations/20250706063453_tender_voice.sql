/*
  ...
  3. Performance
    ...
    - Index on submitter_address for user-specific queries
    - Index on case_number for case lookups
*/
...
DO $$
BEGIN
    -- Drop existing policies for evidence_records
    ...
    -- Drop existing policies for case_records
